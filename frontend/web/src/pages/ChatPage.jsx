    ...
    <div className="p-4 md:p-6 max-w-3xl mx-auto flex flex-col gap-4">
      <div className="bg-mood-card border border-mood-border rounded-xl p-4">
        <div className="flex items-center gap-2 mb-1">
          ...
          <h1 className="text-lg font-bold text-mood-text">聊天推荐</h1>
        </div>
      ...
      <div className="bg-mood-card border border-mood-border rounded-xl p-6 flex flex-col items-center gap-3 text-center">
